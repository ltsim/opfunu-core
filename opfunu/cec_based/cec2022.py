...
class F72022(CecBenchmark):
    ...
    def __init__(self, ndim=None, bounds=None, f_shift="shift_data_7", f_matrix="M_7_D", f_shuffle="shuffle_data_7_D",
        ...
        self.idx1, self.idx2, self.idx3 = self.f_shuffle[:self.n1], self.f_shuffle[self.n1:self.n2], self.f_shuffle[
            self.n2:self.n3]
        self.idx4, self.idx5, self.idx6 = self.f_shuffle[self.n3:self.n4], self.f_shuffle[
            self.n4:self.n5], self.f_shuffle[self.n5:self.ndim]
        self.paras = {"f_shift": self.f_shift, "f_bias": self.f_bias, "f_matrix": self.f_matrix,
                      "f_shuffle": self.f_shuffle}
...
class F82022(CecBenchmark):
    ...
    def __init__(self, ndim=None, bounds=None, f_shift="shift_data_8", f_matrix="M_8_D", f_shuffle="shuffle_data_8_D",
                 f_bias=2200.):
        super().__init__()
        self.dim_changeable = True
        self.dim_default = 10
